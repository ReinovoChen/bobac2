...
public:
    ...
    */
    bool isHeld() const
    {
        return (state & NITE_POSE_STATE_IN_POSE) != 0;
    }
    /**
    ...
    */
    ...
    {
        return (state & NITE_POSE_STATE_ENTER) != 0;
    }
    /**
    ...
    */
    bool isExited() const
    {
        return (state & NITE_POSE_STATE_EXIT) != 0;
    }
};
...
public:
    ...
    */
    const SkeletonJoint& getJoint(JointType type) const
    {
        return (SkeletonJoint&)joints[type];
    }
    /**
...
public:
    ...
    */
    ...
    {
        return (const BoundingBox&)boundingBox;
    }
    /**
    ...
    */
    ...
    {
        return (const Point3f&)centerOfMass;
    }
    /**
    ...
    */
    bool isNew() const
    {
        return (state & NITE_USER_STATE_NEW) != 0;
    }
    /**
    ...
    */
    ...
    {
        return (state & NITE_USER_STATE_VISIBLE) != 0;
    }
    /**
    ...
    */
    bool isLost() const
    {
        return (state & NITE_USER_STATE_LOST) != 0;
    }
    ...
    */
    ...
    {
        return (const Skeleton&)skeleton;
    }
    ...
    */
    ...
    {
        return (const PoseData&)poses[type];
    }
};
...
public:
    ...
    */
    ...
    {
        return m_pFrame->floorConfidence;
    }
    /**
    Get the floor plane
    */
    ...
    {
        return (const Plane&)m_pFrame->floor;
    }
    ...
    */
    ...
    {
        return static_cast<const UserMap&>(m_pFrame->userMap);
    }
    /**
...
public:
    ...
    private:
        ...
        NiteUserTrackerCallbacks& getCallbacks()
        {
            return m_userTrackerCallbacks;
        }
...
public:
    ...
    {
        return (GestureType)type;
    }
    const Point3f& getCurrentPosition() const
    {
        return (Point3f&)currentPosition;
    }

    bool isComplete() const
    {
        return (state & NITE_GESTURE_STATE_COMPLETED) != 0;
    }
    bool isInProgress() const
    {
        return (state & NITE_GESTURE_STATE_IN_PROGRESS) != 0;
    }
};
...
public:
    ...
    bool isNew() const
    {
        return (state & NITE_HAND_STATE_NEW) != 0;
    }
    bool isLost() const
    {
        return state == NITE_HAND_STATE_LOST;
    }
    bool isTracking() const
    {
        return (state & NITE_HAND_STATE_TRACKED) != 0;
    }
    bool isTouchingFov() const
    {
        return (state & NITE_HAND_STATE_TOUCHING_FOV) != 0;
    }
};
...
public:
    ...
    private:
        ...
        NiteHandTrackerCallbacks& getCallbacks()
        {
            return m_handTrackerCallbacks;
        }
